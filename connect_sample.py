...
try:
    # 'wss://<YOUR_ENDPOINT>:443/
    endpoint = 'wss://cjoakim-cosmos-graph1.gremlin.cosmosdb.azure.com:443/'
    username ="/dbs/db1/colls/coll1"
    password = 'h2Dwm7BiqBDSEg8sin2UEOc8GSJShsNBlraTPHFTECJYzqQPlLwM10nawk8O8NJJo3dCNdXNAJd21OsX6nUkSw=='

    client = client.Client(endpoint,'g', username=username, password=password)
